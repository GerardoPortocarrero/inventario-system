...
export const UI_TEXTS = {
  ...
  EDIT_MESA: 'Editar Mesa',
  UPDATE_MESA: 'Guardar Cambios',
  ...
  MESA_NAME_EMPTY: 'El nombre de la mesa no puede estar vacío.',
  MESA_DUPLICATE_ERROR: 'Ya existe una mesa con este nombre en la sede seleccionada.',
